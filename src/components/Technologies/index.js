            ...
            <Row>
              ...
              <Col md={4}>
                <Fade bottom>
                  ...
                  <p className={styles.interestDesc}>
                    I love implementing AI models on a variety of real world problems to try and
                    find solutions.
                  </p>
                </Fade>
              </Col>
              ...
              <Row>
                ...
                <Col md={4}>
                  <Fade bottom>
                    ...
                    <p className={styles.interestDesc}>
                      Taking raw data and finding meaning from it and visualising it is like telling
                      a story.
                    </p>
                  </Fade>
                </Col>
